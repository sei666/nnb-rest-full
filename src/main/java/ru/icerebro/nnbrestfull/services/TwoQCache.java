package ru.icerebro.nnbrestfull.services;
...
public class TwoQCache<K, V> {
     ...
     */
    protected final LinkedHashSet<K> mapIn, mapOut, mapHot;
    ...
    protected int sizeHot;

    protected int maxSizeIn;
    protected int maxSizeOut;
    protected int maxSizeHot;
